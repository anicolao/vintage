...
Status: design for review. No implementation yet. Background: [completed-auction access research](./EBAY_INTEGRATION.md#completed-auctions-pricing-evidence-and-actual-access).
...
```sh
node scripts/investigate-ebay.mjs --site-id SITE_ID ITEM_ID_1 ITEM_ID_2 ITEM_ID_3
```
...
No automated test suite is required for this proof. Manual comparison of a handful of actual responses is the verification. Keep the findings separate from this proposed design until the run has happened.
